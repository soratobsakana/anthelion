    ...
    if (!isset($_SESSION["loggedin"])) {
        ...
        if (isset($_POST["send"])) {
            ...
            if ($_FILES["userfile"]["size"] != 0) {
                ...
                $stmt = $con -> prepare("UPDATE accounts SET pfp = ? WHERE id = " . $_SESSION["id"] . "");
                $stmt -> bind_param('s', $pfpPath);
                $stmt -> execute();
            }
            ...
            if (strlen($_POST["biography-edit"]) >= 240) {
                exit("That biography is looooong. Max biography size is 240 characters, sorry.<br><a href='/'> Comeback</a>");
            }
